...
#define STRING_CONFIG_H_AUTHOR "(carter040, TriGorilaMakerbot1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Makerbot Marlin"
...
#define USE_YMAX_PLUG   // Makerbot homes to X and Y-max endstop
//#define USE_ZMAX_PLUG

// coarse Endstop Settings
// Makerbot 1 endstops switch between +5 and GND
...
// Makerbot 1 endstops have COM to +5V
...
// Aus3D IR probe signals VCC when triggered
 ...
 */
// Taken from
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 20, 26 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.34   // Z offset: -below +above  [the nozzle]
...
// :[-1,1]
#define X_HOME_DIR  1
#define Y_HOME_DIR  1 // Makerbot Homes to the back
#define Z_HOME_DIR -1
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_1_X -84
  #define ABL_PROBE_PT_1_Y -70
  #define ABL_PROBE_PT_2_X -84
  #define ABL_PROBE_PT_2_Y  66
  #define ABL_PROBE_PT_3_X  84
...
//#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 98.55
  #define XY_DIAG_BD 99.3
  #define XY_SIDE_AD 70.4
